...
package com.tglt.sagittarius.wallpaper
...
import com.tglt.sagittarius.util.OmegaSingletonHolder
...
class WallpaperPreviewProvider(private val context: Context) : BroadcastReceiver() {
    ...
    companion object : OmegaSingletonHolder<WallpaperPreviewProvider>(::WallpaperPreviewProvider)
}

...
class SettingsBottomSheet(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs),
    ...
    private val activity = PreferencesActivity.getActivity(context)
    ...
    fun show(view: View, animate: Boolean) {
        Log.d("SettingsBottomSheet", "Abriendo SettingsBottomSheet " + view.toString())
    ...
    companion object {
        ...
        fun inflate(context: Context): SettingsBottomSheet {
            val activity = PreferencesActivity.getActivity(context)
            Log.d("SettingsBottomSheet", "Inflando Vista...")
